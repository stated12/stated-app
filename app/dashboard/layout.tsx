...
{isPro
? <Link href="/upgrade" className={linkClass("/upgrade")}>💳 Buy Credits</Link>
...
className="flex items-center gap-3 px-5 py-3 text-red-600 font-bold"
>
🚪 Logout
</button>
