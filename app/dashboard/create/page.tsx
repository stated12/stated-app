...
// ─── Plan limits (mirrors upgrade page exactly) ───────────────────────────────
...
function CreateCommitmentForm() {
  ...
  // Credit source is company entity when in company workspace, else user profile
  ...
  async function handleSubmit() {
    ...
    // Deduct first, insert second — rollback on failure
      ...
      <div style={{ margin: "-32px -24px", background: "#f2f3f7", minHeight: "100vh" }}>
        ...
        <div style={{ background: "#fff", padding: "16px 16px 14px", borderBottom: "1px solid #f0f1f6" }}>
          <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between" }}>
            ...
            {/* Credits pill */}
            <div
              onClick={() => creditsLeft <= 0 && setShowUpgradeModal(true)}
              style={{
            ...
            >
              ...
              <span style={{ fontSize: 12, fontWeight: 700, color: creditsLeft <= 0 ? "#dc2626" : isLowCredits ? "#92400e" : "#0369a1" }}>
        ...
        <div style={{ padding: 16 }}>
          ...
          <div style={{ background: "#fff", borderRadius: 16, padding: 16, marginBottom: 12, border: "1px solid #f0f1f6" }}>
            ...
            <textarea
              ...
              rows={4}
              style={{
                width: "100%", border: "1.5px solid #e8eaf2", borderRadius: 10,
                padding: "12px 14px", fontSize: 14, color: "#0f0c29",
                outline: "none", fontFamily: "inherit", background: "#f8f9fc",
                ...
                return (
                  <button
                    ...
                    style={{
                      ...
                      border: `1.5px solid ${selected ? accentColor : "#e8eaf2"}`,
