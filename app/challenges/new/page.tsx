...
const TYPE_PLACEHOLDERS: Record<string, {
  title: string; description: string; whatWeNeed: string;
  evalCriteria: string; whatWinnerGets: string;
}> = {
  hiring: {
    title: "e.g. Design our onboarding — best design gets the contract",
    description: "Tell applicants who you are, what you are building, and why this challenge matters...",
    whatWeNeed: "Exactly what should applicants submit? Be specific.",
    evalCriteria: "What criteria will you use to select? Help applicants self-select.",
    whatWinnerGets: "e.g. Rs.25,000 contract, 20% equity, full-time role...",
  },
  cofounder: {
    title: "e.g. Looking for a technical cofounder — build one feature to see if we click",
    description: "Tell applicants about your startup, traction so far, and what you're looking for in a cofounder...",
    whatWeNeed: "What scoped task should they complete to demonstrate fit? Be specific about scope and access needed.",
    evalCriteria: "What will convince you this is the right long-term partner? Technical skill, communication, speed?",
    whatWinnerGets: "e.g. 15-20% equity, cofounder title, decision-making role...",
  },
  partner: {
    title: "e.g. Distribution partner wanted — show us your reseller plan",
    description: "Describe your company, product, and the kind of partnership you're seeking...",
    whatWeNeed: "What should the proposal include? Target market, reach, resources, timeline?",
    evalCriteria: "What makes a strong partner? Reach, credibility, alignment with your ICP?",
    whatWinnerGets: "e.g. 30% revenue share, co-marketing support, exclusive territory...",
  },
  consultant: {
    title: "e.g. Growth consultant needed — solve our retention problem to win the project",
    description: "Describe your business, the problem, and relevant context a consultant would need...",
    whatWeNeed: "What should their diagnosis or proposal include? Be specific about deliverables.",
    evalCriteria: "What separates a generic answer from a great one? Depth, specificity, feasibility?",
    whatWinnerGets: "e.g. Rs.40,000 consulting engagement, ongoing advisory role...",
  },
  investor_signal: {
    title: "e.g. Series A ready — show us why you should back this",
    description: "Describe your startup, traction, market, and what makes this the right moment to invest...",
    whatWeNeed: "What should investors review? Deck, metrics dashboard, product demo, cohort data?",
    evalCriteria: "What signals matter most? Growth rate, retention, market size, team execution?",
    whatWinnerGets: "e.g. Priority access to the round, intro call with founders...",
  },
  collaborator: {
    title: "e.g. Writer wanted for tech newsletter — write one edition to apply",
    description: "Describe your project, audience, and what kind of collaborator you're looking for...",
    whatWeNeed: "What should they create to audition? A full piece, a sample, a mockup?",
    evalCriteria: "What quality bar are you looking for? Voice, originality, consistency?",
    whatWinnerGets: "e.g. Revenue share, byline credit, creative ownership...",
  },
  impact: {
    title: "e.g. Volunteers needed — help us plant 500 trees this quarter",
    description: "Describe your organisation, mission, and the initiative you need help with...",
    whatWeNeed: "What should volunteers or partners submit? A plan, availability, relevant experience?",
    evalCriteria: "What matters most for this initiative? Commitment, local presence, relevant skills?",
    whatWinnerGets: "e.g. Recognition, certificate, ongoing partnership opportunity...",
  },
  grant: {
    title: "e.g. Founder fellowship — best execution wins the seat",
    description: "Describe your program, who it's for, and what makes this opportunity valuable...",
    whatWeNeed: "What should applicants submit? A working prototype, a plan, a case study?",
    evalCriteria: "What are you really evaluating? Execution speed, originality, market understanding?",
    whatWinnerGets: "e.g. Rs.5,00,000 grant, mentorship, cohort access...",
  },
};
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
              ...
              <div>
                ...
                <input
                  ...
                  maxLength={120}
                  placeholder={type ? TYPE_PLACEHOLDERS[type].title : "e.g. Design our onboarding — best design gets the contract"}
              ...
              <div>
                ...
                <textarea
                  ...
                  rows={4}
                  placeholder={type ? TYPE_PLACEHOLDERS[type].description : "Tell applicants who you are, what you are building, and why this challenge matters..."}
              ...
              <div>
                ...
                <textarea
                  ...
                  rows={3}
                  placeholder={type ? TYPE_PLACEHOLDERS[type].whatWeNeed : "Exactly what should applicants submit? Be specific."}
              ...
              <div>
                ...
                <textarea
                  ...
                  rows={3}
                  placeholder={type ? TYPE_PLACEHOLDERS[type].evalCriteria : "What criteria will you use to select? Help applicants self-select."}
              ...
              <div>
                ...
                <input
                  ...
                  placeholder={type ? TYPE_PLACEHOLDERS[type].whatWinnerGets : "e.g. Rs.25,000 contract, 20% equity, full-time role..."}
