          ...
          <>
            ...
            {(openTickets || 0) > 0 && (
              <div style={{ marginTop:12 }}>
                <a href="?period=${period}&tab=tickets" href={`?period=${period}&tab=tickets`} style={{ display:"inline-flex", alignItems:"center", gap:6, fontSize:13, fontWeight:700, color:"#ef4444", textDecoration:"none", background:"#fef2f2", padding:"8px 16px", borderRadius:10, border:"1px solid #fecaca" }}>
